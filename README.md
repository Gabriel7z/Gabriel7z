...
- 🎓 Cursando **Graduação em ADS** pela **IESB**
- 🤖 **Desenvolvedor Python** (**UDAMY, CURSO EM VIDEO**)
- 🧠 **Artificial Intelligence**  (**UDAMY**)
- 🔑 **Administrador de Banco de Dados** (**UDAMY, CURSO EM VIDEO**)
- 🌱 Atualmente estudando Sql, Power bi, Ia e python
